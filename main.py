...
from middleware.auth_middleware import add_auth_middleware  # ✅ Import Middleware
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=origins,  # ✅ Updated to allow multiple origins
...
@app.get("/")
def home():
    return {"message": "Welcome to FastAPI with CORS & Auth Middleware Enabled"}
